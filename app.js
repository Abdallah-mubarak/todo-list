...
// const todoList = document.querySelector(".url_todo");
...
//  //create li
//  const todoli = document.createElement("li");
//  todoli.classList.add("li_todo");

//  //create div
//  const tododiv = document.createElement("div");
//  tododiv.classList.add("name_todo");
...
//  // create button complete
//  const completeBtn = document.createElement("button");
//  completeBtn.classList.add("complet_but");
//  completeBtn.innerHTML = '<i class="fas fa-check"></i>';

//  //create trash buttton
//  const trashBtn = document.createElement("button");
//  trashBtn.classList.add("delet_but");
//  trashBtn.innerHTML = '<i class="fas fa-trash"></i>';
...
//     if (item.classList[0] === "complet_but") {
//     const todo = item.parentElement;
//     todo.classList.toggle("completed");
//     }

//     if (item.classList[0] === "delet_but") {
//     const todo = item.parentElement;
//     todo.classList.toggle("fall");
//     todo.addEventListener("transitionend", () => {
//         todo.remove();});
